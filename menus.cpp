...
void Menu_Informacoes() {
	...
	while (!cin.fail())
	{
		...
		case 0:
			Menu_Principal();
		case 1:
			//FUNÇÃO QUE LÊ CANDIDATOS E INFO BÁSICAS DELES + TIPO DE SESSAO
			break;
		case 2:
			//FUNÇÃO QUE LÊ JURADOS E INFO BÁSICAS
			break;
		case 3:
			Menu_Artes();
			break;
		case 4:
			//FUNÇÃO QUE MOSTRA FICHEIRO DE CANDIDATOS COMO SE FOSSE LER NUM .TXT
			break;
		case 5:
...
void Menu_Artes() {
	...
	cout << "=============================================================\n";
	cout << "Artes disponíveis para Sessões no CASTINGTORIUM 2000: \n";
	cout << "1) Dança";
	cout << "2) Teatro";
	cout << "3) Música";
	cout << "4) Escultura";
